...
// + NEU: Thema 6 – Kommasetzung (extra) mit 10 Übungen
// ================================================================
...
// ================================================================
// 6. TABELLE – Kommasetzung (extra) – NEU
// ================================================================
{
  id:"ueberarbeitung_6",
  title:"6. Kommasetzung (extra)",
  emoji:"🔍",
  color:"#0f766e",
  qs:[

  // 601 – Relativsatz (Maus)
  {
    sub:"Zeichensetzung – Relativsatz",
    type:"komma",
    q:'Setzen Sie die fehlenden Kommas im folgenden Satz:\n\nEine kleine Maus die in Nordengland ein Naturgesetz missachtete erntete dafür eine unerwartete Aufmerksamkeit der Öffentlichkeit.',
    sentence:'Eine kleine Maus die in Nordengland ein Naturgesetz missachtete erntete dafür eine unerwartete Aufmerksamkeit der Öffentlichkeit.',
    correctPositions:[16, 63],
    model:'Eine kleine Maus, die in Nordengland ein Naturgesetz missachtete, erntete dafür …',
    rule:'<div class=rbox>Der Relativsatz „die in Nordengland … missachtete" muss beidseitig durch Kommas abgetrennt werden: Komma nach „Maus" (vor dem Relativpronomen) und Komma nach dem Ende des Relativsatzes (vor „erntete").</div>'
  },

  // 602 – Aufzählung + Relativsatz (Gans)
  {
    sub:"Zeichensetzung – Aufzählung und Relativsatz",
    type:"komma",
    q:'Setzen Sie die fehlenden Kommas im folgenden Satz:\n\nIn früheren Zeiten gab es noch Schlagbäume Brückengeld und Zoll zwischen den einzelnen deutschen Staaten die zum Teil recht klein waren.',
    sentence:'In früheren Zeiten gab es noch Schlagbäume Brückengeld und Zoll zwischen den einzelnen deutschen Staaten die zum Teil recht klein waren.',
    correctPositions:[42, 104],
    model:'… Schlagbäume, Brückengeld und Zoll … Staaten, die zum Teil recht klein waren.',
    rule:'<div class=rbox>Erstes Komma trennt die Aufzählungsglieder „Schlagbäume" und „Brückengeld" (vor „und" kommt kein Komma). Zweites Komma steht vor dem Relativsatz „die … waren".</div>'
  },

  // 603 – Temporalsatz vor Hauptsatz (Indianer)
  {
    sub:"Zeichensetzung – Temporalsatz",
    type:"komma",
    q:'Setzen Sie das fehlende Komma im folgenden Satz:\n\nAls ein Indianer vorbeikam fragte der Siedler diesen: Na wie wird denn der Winter in diesem Jahr?',
    sentence:'Als ein Indianer vorbeikam fragte der Siedler diesen: Na wie wird denn der Winter in diesem Jahr?',
    correctPositions:[26],
    model:'Als ein Indianer vorbeikam, fragte der Siedler diesen: …',
    rule:'<div class=rbox>Der vorangestellte Temporalsatz (mit „als") wird durch Komma vom Hauptsatz getrennt.</div>'
  },

  // 604 – Relativsatz (Daidalos)
  {
    sub:"Zeichensetzung – Relativsatz",
    type:"komma",
    ...
    model:'Die Flügel, die Daidalos baute, waren aus Federn und Wachs.',
    rule:'<div class=rbox>Der Relativsatz „die Daidalos baute" wird beidseitig durch Kommas eingeschlossen.</div>'
  },

  // 605 – Kausalsatz (Daidalos)
  {
    sub:"Zeichensetzung – Kausalsatz",
    type:"komma",
    q:'Setzen Sie das fehlende Komma im folgenden Satz:\n\nNach der Sage stürzte Ikaros ins Meer weil er auf seinem Flug der Sonne zu nahe kam.',
    sentence:'Nach der Sage stürzte Ikaros ins Meer weil er auf seinem Flug der Sonne zu nahe kam.',
    correctPositions:[37],
    model:'… ins Meer, weil er …',
    rule:'<div class=rbox>Vor der kausalen Konjunktion „weil" (Nebensatz) steht ein Komma.</div>'
  },

  // 606 – Temporalsatz + entgegenstellende Konjunktion (Maus)
  {
    sub:"Zeichensetzung – Temporalsatz und 'sondern'",
    type:"komma",
    q:'Setzen Sie die fehlenden Kommas im folgenden Satz:\n\nAls sie nämlich von einem ausgewachsenen Kater gefangen wurde ließ sie sich von diesem nicht fressen sondern stürzte sich todesmutig auf ihren Angreifer und biss zu.',
    sentence:'Als sie nämlich von einem ausgewachsenen Kater gefangen wurde ließ sie sich von diesem nicht fressen sondern stürzte sich todesmutig auf ihren Angreifer und biss zu.',
    correctPositions:[62, 101],
    model:'Als sie … gefangen wurde, ließ sie sich … nicht fressen, sondern stürzte sich …',
    rule:'<div class=rbox>Das erste Komma trennt den vorangestellten Temporalsatz ab, das zweite Komma steht vor der entgegenstellenden Konjunktion „sondern".</div>'
  },

  // 607 – Relativsatz (Siedler)
  {
    sub:"Zeichensetzung – Relativsatz",
    type:"komma",
    ...
    model:'Der alte Siedler, der die Naturverbundenheit der Indianer zu kennen meinte, hackte eifrig weiter.',
    rule:'<div class=rbox>Der Relativsatz „der … meinte" wird beidseitig durch Kommas abgetrennt.</div>'
  },

  // 608 – Infinitivgruppe (guter Rat)
  {
    sub:"Zeichensetzung – Infinitivgruppe",
    type:"komma",
    q:'Setzen Sie das fehlende Komma im folgenden Satz:\n\nEr hatte nicht mit der Möglichkeit gerechnet vom Wachdienst überrascht zu werden.',
    sentence:'Er hatte nicht mit der Möglichkeit gerechnet vom Wachdienst überrascht zu werden.',
    correctPositions:[44],
    model:'… gerechnet, vom Wachdienst überrascht zu werden.',
    rule:'<div class=rbox>Die erweiterte Infinitivgruppe „vom Wachdienst überrascht zu werden" hängt vom Nomen „Möglichkeit" ab und wird durch Komma abgetrennt.</div>'
  },

  // 609 – Apposition (Berlin)
  {
    sub:"Zeichensetzung – Apposition",
    type:"komma",
    q:'Setzen Sie die fehlenden Kommas im folgenden Satz:\n\nBerlin die Hauptstadt ist groß.',
    sentence:'Berlin die Hauptstadt ist groß.',
    correctPositions:[6, 21],
    model:'Berlin, die Hauptstadt, ist groß.',
    rule:'<div class=rbox>Die Apposition „die Hauptstadt" wird beidseitig durch Kommas eingeschlossen.</div>'
  },

  // 610 – Je-desto (Steigerung)
  {
    sub:"Zeichensetzung – Je-desto",
    type:"komma",
    q:'Setzen Sie das fehlende Komma im folgenden Satz:\n\nJe mehr du lernst desto besser wirst du.',
    sentence:'Je mehr du lernst desto besser wirst du.',
    correctPositions:[17],
    model:'Je mehr du lernst, desto besser wirst du.',
    rule:'<div class=rbox>In der korrelativen Konstruktion „je … desto" steht ein Komma vor „desto".</div>'
  }
]},
